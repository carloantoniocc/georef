  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_clasificacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tbl_clasificacion_validate_tpi_codigo_(iNumLinha)
  {
    var nomeCampo_tpi_codigo_ = "tpi_codigo_" + iNumLinha;
    var var_tpi_codigo_ = scAjaxGetFieldSelect(nomeCampo_tpi_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_clasificacion_validate_tpi_codigo_(var_tpi_codigo_, iNumLinha, var_script_case_init, do_ajax_form_tbl_clasificacion_validate_tpi_codigo__cb);
  } // do_ajax_form_tbl_clasificacion_validate_tpi_codigo_

  function do_ajax_form_tbl_clasificacion_validate_tpi_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_clasificacion_validate_tpi_codigo__cb

  // ---------- Validate cla_codigo_
  function do_ajax_form_tbl_clasificacion_validate_cla_codigo_(iNumLinha)
  {
    var nomeCampo_cla_codigo_ = "cla_codigo_" + iNumLinha;
    var var_cla_codigo_ = scAjaxGetFieldHidden(nomeCampo_cla_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_clasificacion_validate_cla_codigo_(var_cla_codigo_, iNumLinha, var_script_case_init, do_ajax_form_tbl_clasificacion_validate_cla_codigo__cb);
  } // do_ajax_form_tbl_clasificacion_validate_cla_codigo_

  function do_ajax_form_tbl_clasificacion_validate_cla_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_clasificacion_validate_cla_codigo__cb

  // ---------- Validate cla_descripcion_
  function do_ajax_form_tbl_clasificacion_validate_cla_descripcion_(iNumLinha)
  {
    var nomeCampo_cla_descripcion_ = "cla_descripcion_" + iNumLinha;
    var var_cla_descripcion_ = scAjaxGetFieldText(nomeCampo_cla_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_clasificacion_validate_cla_descripcion_(var_cla_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_tbl_clasificacion_validate_cla_descripcion__cb);
  } // do_ajax_form_tbl_clasificacion_validate_cla_descripcion_

  function do_ajax_form_tbl_clasificacion_validate_cla_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cla_descripcion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cla_descripcion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cla_descripcion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cla_descripcion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_clasificacion_validate_cla_descripcion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbl_clasificacion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbl_clasificacion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbl_clasificacion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbl_clasificacion_add_new_line_cb);
  } // do_ajax_form_tbl_clasificacion_add_new_line

  function do_ajax_form_tbl_clasificacion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tbl_clasificacion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbl_clasificacion_backup_line(iNumLinha)
  {
    var var_tpi_codigo_ = scAjaxGetFieldSelect("tpi_codigo_" + iNumLinha);
    var var_cla_codigo_ = scAjaxGetFieldHidden("cla_codigo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_clasificacion_backup_line(var_tpi_codigo_, var_cla_codigo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbl_clasificacion_backup_line_cb);
  } // do_ajax_form_tbl_clasificacion_backup_line

  function do_ajax_form_tbl_clasificacion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_tbl_clasificacion_backup_line_cb

  function do_ajax_form_tbl_clasificacion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbl_clasificacion_cancel_insert

  function do_ajax_form_tbl_clasificacion_cancel_update(iSeqVert)
  {
    do_ajax_form_tbl_clasificacion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbl_clasificacion_cancel_update

  function do_ajax_form_tbl_clasificacion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbl_clasificacion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbl_clasificacion_table_refresh()
  {
    var var_tpi_codigo_ = document.F2.tpi_codigo_.value;
    var var_cla_codigo_ = document.F2.cla_codigo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_clasificacion_table_refresh(var_tpi_codigo_, var_cla_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_clasificacion_table_refresh_cb);
  } //  do_ajax_form_tbl_clasificacion_table_refresh

  function do_ajax_form_tbl_clasificacion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.tpi_codigo_.value = scAjaxGetKeyValue("tpi_codigo_");
    document.F2.cla_codigo_.value = scAjaxGetKeyValue("cla_codigo_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbl_clasificacion_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbl_clasificacion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbl_clasificacion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_tpi_codigo_ = scAjaxGetFieldSelect("tpi_codigo_" + iNumLinha);
    var var_cla_codigo_ = scAjaxGetFieldHidden("cla_codigo_" + iNumLinha);
    var var_cla_descripcion_ = scAjaxGetFieldText("cla_descripcion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbl_clasificacion_submit_form(var_tpi_codigo_, var_cla_codigo_, var_cla_descripcion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_clasificacion_submit_form_cb);
  } // do_ajax_form_tbl_clasificacion_submit_form

  function do_ajax_form_tbl_clasificacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("cla_descripcion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_tbl_clasificacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_clasificacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbl_clasificacion_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("cla_descripcion_" + iNavForm);
    }
    var var_tpi_codigo_ = document.F2.tpi_codigo_.value;
    var var_cla_codigo_ = document.F2.cla_codigo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_clasificacion_navigate_form(var_tpi_codigo_, var_cla_codigo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_clasificacion_navigate_form_cb);
  } // do_ajax_form_tbl_clasificacion_navigate_form

  function do_ajax_form_tbl_clasificacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.tpi_codigo_.value = scAjaxGetKeyValue("tpi_codigo_" + var_last_index);
    document.F2.cla_codigo_.value = scAjaxGetKeyValue("cla_codigo_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_tbl_clasificacion_navigate_form_cb
  function sc_hide_form_tbl_clasificacion_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tbl_clasificacion_form


  function do_ajax_form_tbl_clasificacion_lkpedt_refresh_cla_codigo_(iSeq)
  {
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "cla_codigo_";
    x_ajax_form_tbl_clasificacion_lkpedt_refresh_cla_codigo_(nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_tbl_clasificacion_lkpedt_refresh_cla_codigo__cb);
  } // do_ajax_form_tbl_clasificacion_lkpedt_refresh_cla_codigo_

  function do_ajax_form_tbl_clasificacion_lkpedt_refresh_cla_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
  } // do_ajax_form_tbl_clasificacion_lkpedt_refresh_cla_codigo__cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cla_descripcion_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["cla_codigo_" + iNumLinha] = {"label": "Código Clasificación<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cla_descripcion_" + iNumLinha] = {"label": "Descripción Clasificación<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["tpi_codigo_"][iNumLinha] = "tpi_codigo_" + iNumLinha;
    ajax_field_mult["cla_codigo_"][iNumLinha] = "cla_codigo_" + iNumLinha;
    ajax_field_mult["cla_descripcion_"][iNumLinha] = "cla_descripcion_" + iNumLinha;
    ...
    ajax_field_id["cla_descripcion_" + iNumLinha] = new Array("hidden_field_label_cla_descripcion_", "hidden_field_data_cla_descripcion_" + iNumLinha);
    ajax_error_count["tpi_codigo_" + iNumLinha] = "off";
    ajax_error_count["cla_codigo_" + iNumLinha] = "off";
    ajax_error_count["cla_descripcion_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["cla_descripcion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["tpi_codigo_" + iNumLinha] = "on";
    ajax_read_only["cla_codigo_" + iNumLinha] = "on";
    ajax_read_only["cla_descripcion_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["cla_descripcion_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["cla_descripcion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cla_descripcion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cla_descripcion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cla_descripcion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cla_descripcion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tpi_codigo_'])) ? $this->nmgp_cmp_readonly['tpi_codigo_'] : 'on';
?>
    scAjaxFieldRead("tpi_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cla_codigo_'])) ? $this->nmgp_cmp_readonly['cla_codigo_'] : 'on';
?>
    scAjaxFieldRead("cla_codigo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cla_descripcion_'])) ? $this->nmgp_cmp_readonly['cla_descripcion_'] : 'off';
?>
    scAjaxFieldRead("cla_descripcion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("cla_descripcion_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tpi_codigo_" + iRow] || "on" == ajax_error_count["cla_codigo_" + iRow] || "on" == ajax_error_count["cla_descripcion_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_cla_descripcion_" + iRow))
        document.getElementById("hidden_field_data_cla_descripcion_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tpi_codigo_" + iRow] && "off" == ajax_error_count["cla_codigo_" + iRow] && "off" == ajax_error_count["cla_descripcion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tpi_codigo_" + iRow] = "off";
        ajax_error_count["cla_codigo_" + iRow] = "off";
        ajax_error_count["cla_descripcion_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_cla_descripcion_" + iRow))
        document.getElementById("hidden_field_data_cla_descripcion_" + iRow).className = sCssLine;
    }
  }
