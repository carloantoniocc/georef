<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="tpi_codigo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tpi_codigo_']); ?>">
<input type="hidden" name="cla_codigo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cla_codigo_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tbl_clasificacion"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_tbl_clasificacion_submit_form(y, z); 
} 
<?php
}
?>
