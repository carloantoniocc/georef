...
$old_error_handler = set_error_handler("mensaje_mob_scriptcase_error_handler");

function mensaje_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['mensaje_mob']['contr_erro']) && $_SESSION['scriptcase']['mensaje_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_mensaje_mob->contr_mensaje_mob->Apl_com_erro = true;
            if ($inicial_mensaje_mob->contr_mensaje_mob->NM_ajax_flag)
            {
                $inicial_mensaje_mob->contr_mensaje_mob->NM_ajax_info['errList']['geral_mensaje_mob'][] = $msg;
                return;
            }
            mensaje_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function mensaje_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['mensaje_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['mensaje_mob'])  ? $_SESSION['scriptcase']['error_icon']['mensaje_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['mensaje_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['mensaje_mob']) ? $_SESSION['scriptcase']['error_span_title']['mensaje_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['mensaje_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['mensaje_mob']) ? $_SESSION['scriptcase']['error_icon_title']['mensaje_mob'] : '';
?>
