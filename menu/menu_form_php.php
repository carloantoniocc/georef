...
class menu_form_php
{
   ...
   function init()
   {
      ...
      $this->str_conf_reg  = (isset($_SESSION['scriptcase']['str_conf_reg']) && !empty($_SESSION['scriptcase']['str_conf_reg'])) ? $_SESSION['scriptcase']['str_conf_reg'] : "es_cl";
...
<?php
      ...
      {
              $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_tbl_archivos_1") . "/?nm_run_menu=1&nm_apl_menu=menu&script_case_init=1&script_case_session=" . session_id() . "";
      }
