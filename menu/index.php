...
else
{
    ...
    $_SESSION['scriptcase']['menu']['glo_nm_perfil']    = "geobd";
...
$str_button = (isset($_SESSION['scriptcase']['str_button_all'])) ? $_SESSION['scriptcase']['str_button_all'] : "Georef";
...
$this->tab_grupo[0] = "Georeferencia/";
if ($_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_tbl_archivos_1") . "/form_tbl_archivos_1_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tbl_archivos_1']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_tbl_archivos_1'] = "on";
    }
}
...
<head>
 <title>Sistema de información territorial Servicio de Salud Metropolitano Occidente</title>
...
<div style="overflow-x:auto;">
  <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
    <TR valign="middle">
      <TD align="left" rowspan="3" width="10%" class="scMenuHHeaderFont">
           <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__img__NM__logo.png" BORDER="0"/>
      </TD>
      <TD align="left" width="70%" style="font-size:3vw;color:#0063AE" class="scMenuHHeaderFont">
        <?php echo "Sistema de información territorial<br> Servicio de Salud Metropolitano Occidente" ?>
      </TD>
      <TD align="center" width="30%" class="scMenuHHeaderFont">
           <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__img__NM__logo_GeoReferencia_OK_147px.jpg" BORDER="0"/>
      </TD>
    </TR>
  </TABLE>
</div>    </td>
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tbl_archivos_1']) && $_SESSION['scriptcase']['sc_apl_seg']['form_tbl_archivos_1'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=form_tbl_archivos_1&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
} 
else
{ 
...
?></td>
 ...
 <TABLE border="0" bgcolor="#4D6A79" cellpadding="0" cellspacing="0" width="100%" class="css_tabela">
    <TR align="center">
     <TD>
