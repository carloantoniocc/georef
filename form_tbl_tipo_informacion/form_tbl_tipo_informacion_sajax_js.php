  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_tipo_informacion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tpi_codigo
  function do_ajax_form_tbl_tipo_informacion_validate_tpi_codigo()
  {
    var nomeCampo_tpi_codigo = "tpi_codigo";
    var var_tpi_codigo = scAjaxGetFieldHidden(nomeCampo_tpi_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_tipo_informacion_validate_tpi_codigo(var_tpi_codigo, var_script_case_init, do_ajax_form_tbl_tipo_informacion_validate_tpi_codigo_cb);
  } // do_ajax_form_tbl_tipo_informacion_validate_tpi_codigo

  function do_ajax_form_tbl_tipo_informacion_validate_tpi_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_tipo_informacion_validate_tpi_codigo_cb

  // ---------- Validate tpi_descripcion
  function do_ajax_form_tbl_tipo_informacion_validate_tpi_descripcion()
  {
    var nomeCampo_tpi_descripcion = "tpi_descripcion";
    var var_tpi_descripcion = scAjaxGetFieldText(nomeCampo_tpi_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_tipo_informacion_validate_tpi_descripcion(var_tpi_descripcion, var_script_case_init, do_ajax_form_tbl_tipo_informacion_validate_tpi_descripcion_cb);
  } // do_ajax_form_tbl_tipo_informacion_validate_tpi_descripcion

  function do_ajax_form_tbl_tipo_informacion_validate_tpi_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_tipo_informacion_validate_tpi_descripcion_cb
  // ---------- Form
  function do_ajax_form_tbl_tipo_informacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_tipo_informacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_tipo_informacion_submit_form(var_tpi_codigo, var_tpi_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_tipo_informacion_submit_form_cb);
  } // do_ajax_form_tbl_tipo_informacion_submit_form

  function do_ajax_form_tbl_tipo_informacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbl_tipo_informacion_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_tipo_informacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_tipo_informacion_navigate_form(var_tpi_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_tipo_informacion_navigate_form_cb);
  } // do_ajax_form_tbl_tipo_informacion_navigate_form

  function do_ajax_form_tbl_tipo_informacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tbl_tipo_informacion_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_tbl_tipo_informacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_tipo_informacion_navigate_form_cb
  function sc_hide_form_tbl_tipo_informacion_form()
  {
