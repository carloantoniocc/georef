  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_tipo_informacion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tpi_codigo
  function do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_codigo()
  {
    var nomeCampo_tpi_codigo = "tpi_codigo";
    var var_tpi_codigo = scAjaxGetFieldHidden(nomeCampo_tpi_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_tipo_informacion_mob_validate_tpi_codigo(var_tpi_codigo, var_script_case_init, do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_codigo_cb);
  } // do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_codigo

  function do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_codigo_cb

  // ---------- Validate tpi_descripcion
  function do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_descripcion()
  {
    var nomeCampo_tpi_descripcion = "tpi_descripcion";
    var var_tpi_descripcion = scAjaxGetFieldText(nomeCampo_tpi_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_tipo_informacion_mob_validate_tpi_descripcion(var_tpi_descripcion, var_script_case_init, do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_descripcion_cb);
  } // do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_descripcion

  function do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tpi_descripcion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_tipo_informacion_mob_validate_tpi_descripcion_cb
  // ---------- Form
  function do_ajax_form_tbl_tipo_informacion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_tipo_informacion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tpi_codigo = scAjaxGetFieldHidden("tpi_codigo");
    var var_tpi_descripcion = scAjaxGetFieldText("tpi_descripcion");
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_tipo_informacion_mob_submit_form(var_tpi_codigo, var_tpi_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_tipo_informacion_mob_submit_form_cb);
  } // do_ajax_form_tbl_tipo_informacion_mob_submit_form

  function do_ajax_form_tbl_tipo_informacion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("tpi_descripcion");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_tbl_tipo_informacion_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_tipo_informacion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tpi_codigo");
    scAjaxHideErrorDisplay("tpi_descripcion");
    var var_tpi_codigo = document.F2.tpi_codigo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_tipo_informacion_mob_navigate_form(var_tpi_codigo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_tipo_informacion_mob_navigate_form_cb);
  } // do_ajax_form_tbl_tipo_informacion_mob_navigate_form

  function do_ajax_form_tbl_tipo_informacion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tbl_tipo_informacion_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.tpi_codigo.value = scAjaxGetKeyValue("tpi_codigo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tbl_tipo_informacion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbl_tipo_informacion_mob_navigate_form_cb
  function sc_hide_form_tbl_tipo_informacion_mob_form()
  {
  ...
  ajax_field_list[0] = "tpi_codigo";
  ajax_field_list[1] = "tpi_descripcion";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "tpi_codigo": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tpi_descripcion": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "tpi_descripcion": new Array()
  };
  ajax_field_mult["tpi_codigo"][1] = "tpi_codigo";
  ajax_field_mult["tpi_descripcion"][1] = "tpi_descripcion";

  var ajax_field_id = {
    "tpi_codigo": new Array("hidden_field_label_tpi_codigo", "hidden_field_data_tpi_codigo"),
    "tpi_descripcion": new Array("hidden_field_label_tpi_descripcion", "hidden_field_data_tpi_descripcion")
  };
