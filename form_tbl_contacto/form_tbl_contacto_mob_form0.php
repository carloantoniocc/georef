...
<?php
include_once("form_tbl_contacto_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tbl_contacto_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['recarga'];
}
?>
...
<?php
 include_once("form_tbl_contacto_mob_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<form name="F1" method="post" 
               action="form_tbl_contacto_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tbl_contacto_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tbl_contacto_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_nombre_line" id="hidden_field_data_con_nombre" style="<?php echo $sStyleHidden_con_nombre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_nombre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_nombre_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_nombre'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_con_nombre"><?php echo $this->nm_new_label['con_nombre']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_apellido_line" id="hidden_field_data_con_apellido" style="<?php echo $sStyleHidden_con_apellido; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_apellido_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_apellido_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_apellido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_apellido'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_con_apellido"><?php echo $this->nm_new_label['con_apellido']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_email_line" id="hidden_field_data_con_email" style="<?php echo $sStyleHidden_con_email; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_email_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_email_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_email'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_con_email"><?php echo $this->nm_new_label['con_email']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tcc_id_line" id="hidden_field_data_tcc_id" style="<?php echo $sStyleHidden_tcc_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tcc_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tcc_id_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['tcc_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['tcc_id'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_tcc_id"><?php echo $this->nm_new_label['tcc_id']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_con_sobre_id_line" id="hidden_field_data_con_sobre_id" style="<?php echo $sStyleHidden_con_sobre_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_con_sobre_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_con_sobre_id_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_sobre_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['con_sobre_id'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_con_sobre_id"><?php echo $this->nm_new_label['con_sobre_id']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comentario_line" id="hidden_field_data_comentario" style="<?php echo $sStyleHidden_comentario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_comentario_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['comentario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['php_cmp_required']['comentario'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_comentario"><?php echo $this->nm_new_label['comentario']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_contacto_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_tbl_contacto_mob");
 parent.scAjaxDetailHeight("form_tbl_contacto_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
