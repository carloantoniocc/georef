...
class pdfreport_tbl_archivos_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_tbl_archivos_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "pdfreport_tbl_archivos.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbl_archivos']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbl_archivos']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbl_archivos']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbl_archivos']['xls_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbl_archivos']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_tbl_archivos']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - tbl_archivos :: Excel</TITLE>
